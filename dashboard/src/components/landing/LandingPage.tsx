  ...
  return (
    <div className="min-h-screen overflow-hidden relative flex flex-col items-center justify-center px-4 py-16 bg-linear-to-b from-background to-muted/30">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto mt-30 flex flex-col items-center">
        ...
        {/* Video area — BorderTrail on placeholder and when video is present */}
        <div
          className="relative mt-12 w-full max-w-4xl animate-landing-entry opacity-0 rounded-xl border border-border bg-muted/50 aspect-video flex items-center justify-center text-muted-foreground overflow-hidden"
        ...
        >
          ...
          />
          <span className="relative z-10 text-sm font-medium">Video placeholder</span>
        </div>
      </div>
      <SignInDialog
        open={signInOpen}
