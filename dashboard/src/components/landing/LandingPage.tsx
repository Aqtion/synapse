  ...
  return (
    <div className="min-h-screen overflow-hidden relative flex flex-col items-center justify-center px-4 py-16 bg-gradient-to-b from-background to-muted/30">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <DecorativeLogo
          className="absolute -left-[15%] -top-[10%] w-[min(90vmax,28rem)] h-auto text-foreground opacity-10 from-foreground to-background"
          ariaHidden
        />
        <DecorativeLogo
          className="absolute top-1/2 -right-[15%] -translate-y-1/2 w-[min(90vmax,32rem)] h-auto text-foreground opacity-10"
          ariaHidden
        />
      </div>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto mt-30 flex flex-col items-center">
        ...
        <div className="text-center space-y-6 animate-landing-entry opacity-0">
          <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl">
            The most complete UI/UX feedback loop ever.
          </h1>
        ...
        {/* Video placeholder — same slide-in/up animation with delay */}
        <div
          className="mt-12 w-full max-w-4xl animate-landing-entry opacity-0 rounded-xl border border-border bg-muted/50 aspect-video flex items-center justify-center text-muted-foreground"
