...
import { BarChart, FolderKanban, LayoutDashboard, Moon, Plus, Sun, User } from "lucide-react";
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="border-b border-sidebar-border">
        <SidebarMenuButton asChild className="w-full justify-start min-w-0 px-2 py-2">
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={pathname === `/${userId}`}>
                  <Link href={`/${userId}`}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <Link href={`/${userId}/create_project`}>
